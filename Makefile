...
$(pokered_obj):    RGBASMFLAGS += -D _RED -D _ENCRED -D _FPLAYER -D _MOVENPCS -D _RUNSHOES -D _EXPBAR 
$(pokeblue_obj):   RGBASMFLAGS += -D _BLUE -D _ENCBLUEGREEN -D _FPLAYER -D _MOVENPCS -D _RUNSHOES -D _EXPBAR 

...
PrintDiploma:
	...
	call ClearScreen
	ld de, DiplomaPikachuGraphics
	ld hl, vChars2
	lb bc, BANK(DiplomaPikachuGraphics), (DiplomaPikachuGraphicsEnd - DiplomaPikachuGraphics) / $10
	call CopyVideoData

	callba _DisplayDiploma
	ld a, $01
	ldh [H_AUTOBGTRANSFERENABLED], a
...
;This is used for the diploma as well as the Pikachu's Beach high score screen
